export default {
  ...
  fileManager: {
    searchPlaceholder: '描述你想找的文件，如"Downloads 里超过 100MB 的视频"',
    search: '搜索',
    searching: '搜索中…',
    parsing: 'AI 解析中…',
    aiExplanation: 'AI 解析结果',
    searchConditions: '搜索条件',
    noResults: '未找到匹配的文件',
    totalMatched: '共匹配 {count} 个文件',
    truncatedHint: '（结果已截断，显示前 {max} 项）',
    elapsed: '耗时 {ms}ms',
    fileName: '文件名',
    fileSize: '大小',
    fileModified: '修改时间',
    ...
    confirmRename: '确认重命名',
    confirmDelete: '确认删除',
    moveDestination: '移动目标路径',
    moveDestPlaceholder: '输入目标文件夹路径',
    newName: '新文件名',
    newNamePlaceholder: '输入新的文件名',
    operationSuccess: '操作完成: {succeeded} 成功, {failed} 失败',
    confirmMoveDesc: '以下 {count} 个文件将被移动到:',
    confirmDeleteDesc: '以下 {count} 个文件将被移入沙箱回收站:',
    confirmRenameDesc: '以下文件将被重命名:',
    opsHistory: '操作历史',
    noHistory: '暂无操作记录',
    historyOpType: '操作',
    historySource: '源路径',
  ...
  dashboard: {
    ...
    quickActions: {
      explorerTitle: '文件浏览',
      explorerDesc: '浏览、搜索和管理文件',
      scanTitle: '立即扫描',
      scanDesc: '全盘 + AI 智能分类',
      mapTitle: '磁盘地图',
      mapDesc: 'Treemap 可视化目录',
      historyTitle: '操作历史',
      historyDesc: '查看操作记录和回收站',
    },
    highRisk: {
      title: '高风险候选 · Top 5',
  ...
  explorer: {
    ...
    action: {
      moveTitle: '移动 {count} 项',
      moveDesc: '将选中的文件（共 {size}）移动到目标文件夹',
      renameTitle: '重命名',
      renameDesc: '输入新的文件名',
      deleteTitle: '删除 {count} 项',
      deleteDesc: '将选中的文件（共 {size}）永久删除，此操作不可撤销',
      destination: '目标路径',
      newName: '新名称',
      confirmMove: '移动',
      confirmRename: '重命名',
      confirmDelete: '删除',
      success: '操作完成，{count} 项成功',
      deleted: '已删除 {count} 项（可撤回）',
      partial: '{ok} 项成功，{fail} 项失败',
      failed: '操作失败：{message}',
