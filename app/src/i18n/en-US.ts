export default {
  ...
  dashboard: {
    ...
    quickActions: {
      ...
      explorerDesc: 'Browse, search & manage files',
      scanTitle: 'Scan Now',
      scanDesc: 'Full disk + AI categorization',
      mapTitle: 'Disk Map',
      mapDesc: 'Treemap visualization',
      historyTitle: 'History',
      historyDesc: 'Operation logs & trash recovery',
    },
    highRisk: {
  ...
  explorer: {
    ...
    action: {
      ...
      moveDesc: 'Move selected files ({size}) to a destination folder',
      renameTitle: 'Rename',
      renameDesc: 'Enter a new file name',
      deleteTitle: 'Delete {count} items',
      deleteDesc: 'Permanently delete selected files ({size}). This cannot be undone',
      destination: 'Destination path',
      newName: 'New name',
      confirmMove: 'Move',
      confirmRename: 'Rename',
      confirmDelete: 'Delete',
      success: '{count} items completed successfully',
      deleted: '{count} items deleted (undo available)',
    ...
    aiSuggest: {
      ...
      loading: 'Analyzing current directory…',
